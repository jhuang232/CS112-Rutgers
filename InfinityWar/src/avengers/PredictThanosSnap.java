...
public class PredictThanosSnap {
    ...
    public static void main(String[] args) {
        ...
        String thanosSnapInput = args[0];
        String thanosSnapOutput = args[1];

        // sets input file
        StdIn.setFile(thanosSnapInput);
        ...
        // delete random vertices and updated deletedverticies
        boolean[] deletedVertices = new boolean[vertices];
        ...
        for (int t = 0; t < matrix.length; t++) {
            // if it hasn't been delteted and it has not connections to any thing else then
            // it is false
            if (!deletedVertices[t]) {
                for (int n = 0; n < matrix.length; n++) {
                    if (matrix[t][n] != 0 || matrix[n][t] != 0) {
                        break;
                    }
        ...
        // set ouput file
        StdOut.setFile(thanosSnapOutput);
        // print to output
